                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.brand.add') }}" class="">
                                                <div class="text">Создать Бренд</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.category.add') }}" class="">
                                                <div class="text">Создать Категорию</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="order-tracking.html" class="">
                                                <div class="text">Ослеживание Заказов</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt=""
                                        src="images/logo/logo.png" data-light="{{ asset('images/logo/logo.png') }}"
