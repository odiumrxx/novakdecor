                        ...
                        <div class="product-card-wrapper">
                            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                <div class="pc__img-wrapper">
                                    <a href="#">
                                        <img loading="lazy"
                                            src="{{ $product->image ? asset('uploads/products/' . $product->image) : asset('images/upload/upload-1.png') }}"
                                            alt="$product->name" class="pc__img">
                                    </a>
                                    <!-- Кнопки Add To Cart и Add To Wishlist скрыты через CSS -->
                                </div>
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <div class="product-card__price d-flex">
                                        <span class="money price">
                                            @if ($product->sale_price)
                                                <s>{{ $product->regular_price }} руб</s> {{ $product->sale_price }} руб
                                            @else
                                    ...
                                    <!-- Кнопка Add To Wishlist скрыта через CSS -->
                                    <div class="product-card__actions">
                                        <button class="btn btn-sample">Получить образец</button>
