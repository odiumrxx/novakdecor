            ...
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data"
                ...
                <div class="wg-box">
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image mb-16 flex flex-row-reverse gap10 mb-10" id="gallery-preview-container">
                        ...
                        <div class="select mb-10">
                            <select class="" name="stock_status">
                                <option value="instock" {{ old('stock_status') == 'instock' ? 'selected' : '' }}>В
                                    наличии</option>
                                <option value="outofstock" {{ old('stock_status') == 'outofstock' ? 'selected' : '' }}>Нет
                                    в наличии</option>
                            </select>
                        </div>
                    </fieldset>
            ...
            $("#gFile").on("change", function(e) {
                ...
                if (files.length > 0) {
                    for (let i = 0; i < files.length; i++) {
                        ...
                        galleryPreviewContainer.append(itemDiv); // Добавляем в основной контейнер
                    }
                }
            });
        });
